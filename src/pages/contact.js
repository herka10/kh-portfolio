        ...
        <div className="container">
          ...
          {/* <form onSubmit={submitForm}
            ...
            <div className="form-group mb-2">
              ...
              <input type="text" className="form-control" id="exampleFormControlInput1" placeholder="kaonou" />
            </div>
            ...
            <div className="form-group mb-3">
              ...
              <textarea className="form-control" id="exampleFormControlTextarea1" rows="4" placeholder="Hi Kaonou!"></textarea>
            </div>
          </form> */}

      ...
      <div className="row row-cols-1 row-cols-md-3">
        <div className="col mb-4">
          <div className="card h-100">
            <a href="https://herka10.github.io/password-generator/">
        ...
        <div className="col mb-4">
          <div className="card h-100">
            <a href='https://herka10.github.io/Daily-Work-Scheduler/'>
        ...
        <div className="col mb-4">
          <div className="card h-100">
            <a href='https://expressnote-taking.herokuapp.com/'>
        ...
        <div className="col mb-4">
          <div className="card h-100">
            <a href='https://mvctech-blog.herokuapp.com/'>
